...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="animate-fade-up fixed left-0 right-0 top-0 z-50">
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="fixed inset-x-0 top-[72px] z-50 border-b border-gray-200 bg-white/95 px-6 pb-6 pt-2 backdrop-blur-xl md:hidden">
          ...
          <div className="mt-4 flex flex-col gap-3">
            <Link href="/login" className="rounded-xl border border-gray-200 px-4 py-3 text-center text-sm font-medium text-gray-700">
              Log in
            </Link>
            <a
              href={CALENDLY_URL}
