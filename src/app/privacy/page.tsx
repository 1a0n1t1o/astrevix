        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5">
              ...
              <li>To send email notifications about submission status and reward delivery</li>
          ...
          <section>
            ...
            <p className="mt-2">
              By providing your email address and checking the consent box, you agree to receive email notifications from
              Astrevix on behalf of the business. These emails may include:
            </p>
            <ul className="mt-3 list-disc space-y-2 pl-5">
              ...
              <li>A status update email if your submission is not approved</li>
            </ul>
            <p className="mt-3">
              <strong>Email frequency:</strong> You may receive up to 3 emails per submission
              (confirmation, status update, and reward delivery).
            </p>
            <p className="mt-2">
              <strong>Opt-out:</strong> To unsubscribe from future emails, contact us at{" "}
              <a href="mailto:contact@astrevix.com" className="underline hover:text-gray-900">
                contact@astrevix.com
              </a>.
            </p>
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5">
              <li>
                <strong>Resend</strong> &mdash; For sending email notifications. Your email address is
                shared with Resend to deliver emails. See{" "}
                <a
          ...
          <section>
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5">
              <li>Opt out of email communications by contacting us</li>
