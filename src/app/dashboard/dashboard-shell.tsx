...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.34 15.84c-.688-.06-1.386-.09-2.09-.09H7.5a4.5 4.5 0 110-9h.75c.704 0 1.402-.03 2.09-.09m0 9.18c.253.962.584 1.892.985 2.783.247.55.06 1.21-.463 1.511l-.657.38a.75.75 0 01-1.023-.274l-.41-.71a7.5 7.5 0 01-.573-1.073 6.009 6.009 0 01-.44-1.617m2.581-7.5c-.253-.962-.584-1.892-.985-2.783a1.125 1.125 0 01.463-1.511l.657-.38a.75.75 0 011.023.274l.41.71c.243.42.44.868.573 1.073a6.009 6.009 0 01.44 1.617m-2.581 7.5h5.732a.75.75 0 00.707-.5l1.795-5.385A.75.75 0 0018.568 9H15.5" />
      </svg>
    ),
  },
  {
